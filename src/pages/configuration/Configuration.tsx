...
const Configuration = () => {
      ...
      const {
            ...
            defaultValues: {
                  message: message || "Necesito ayuda. Mi ubicación actual es:",
            },
      });
      ...
      return (
            <Container>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} action="" className=" px-6 ">
                        ...
                        <button className=" py-2 px-6 my-6 rounded-xl bg-bg-primary text-text-muted-light text-sm " type="submit">Comenzar</button>
                  </form>
